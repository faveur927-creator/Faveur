  ...
  const handleGoogleLogin = async () => {
    try {
        ...
        if (user.email && user.displayName) {
            // First, try to register the user. The backend logic will handle existing users.
                ...
                if (loginResult.userId && loginResult.name) {
                    ...
                    router.push('/');
                     ...
                     toast({
                        ...
                        description: "Impossible de se connecter après l'inscription avec Google.",
                    });
                }
            } else {
                 toast({
                    ...
                    description: "Impossible de créer un compte avec Google.",
                });
            }
        }
    } catch (error) {
